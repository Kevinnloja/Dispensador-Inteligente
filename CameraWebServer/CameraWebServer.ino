...
// Define tus credenciales de WiFi
...
void setup() {
  ...
  // Envia la dirección IP a Firebase
  FirebaseData data;
  String path = "/IP_Address";
  Firebase.set(data, path.c_str(), ipAddress.c_str());

  if (data.dataType() == "string") {
    Serial.println("Dirección IP enviada a Firebase: " + ipAddress);
  } else {
    Serial.println("Error al enviar la dirección IP a Firebase");
